#include "stdafx.h"
#include "..\Headers\Denden.h"

#include "Management.h"

CDenden::CDenden(DEVICES)
	:CObjList(pDevice, pDeviceContext)
{
}

CDenden::CDenden(const CDenden & other)
	: CObjList(other)
{
}

HRESULT CDenden::Initialize_Prototype()
{
...
HRESULT CDenden::Initialize_Clone(void * pArg)
{
...
_int CDenden::Update(_double DeltaTime)
{
...
_int CDenden::Late_Update(_double DeltaTime)
{
...
HRESULT CDenden::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CDenden::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CDenden * CDenden::Create(DEVICES)
{
	CDenden*		pInstance = new CDenden(pDevice, pDeviceContext);
...
CObj * CDenden::Clone(void * pArg)
{
	CDenden*		pInstance = new CDenden(*this);
