...
HRESULT CMelon::SetUp_Components()
{
	...
	ModelDesc.iModelIndexNum = 21;
	if (FAILED(__super::SetUp_Components(STAGEONE_SCENE, L"Component_Model_Melon", L"Com_Model", (CComponent**)&m_pModel, &ModelDesc)))
		return E_FAIL;
...
CMelon * CMelon::Create(DEVICES)
{
	...
	{
		MSG_BOX("Failed to Creating CMelon");
