...
HRESULT CLipStick::SetUp_Components()
{
	...
	ModelDesc.iModelIndexNum = 19;
	if (FAILED(__super::SetUp_Components(STAGEONE_SCENE, L"Component_Model_LipStick", L"Com_Model", (CComponent**)&m_pModel, &ModelDesc)))
		return E_FAIL;
...
CLipStick * CLipStick::Create(DEVICES)
{
	...
	{
		MSG_BOX("Failed to Creating CLipStick");
