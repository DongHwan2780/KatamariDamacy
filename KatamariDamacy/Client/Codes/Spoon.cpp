#include "stdafx.h"
#include "..\Headers\Spoon.h"

#include "Management.h"

CSpoon::CSpoon(DEVICES)
	:CObjList(pDevice, pDeviceContext)
{
}

CSpoon::CSpoon(const CSpoon & other)
	: CObjList(other)
{
}

HRESULT CSpoon::Initialize_Prototype()
{
...
HRESULT CSpoon::Initialize_Clone(void * pArg)
{
...
_int CSpoon::Update(_double DeltaTime)
{
...
_int CSpoon::Late_Update(_double DeltaTime)
{
...
HRESULT CSpoon::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CSpoon::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CSpoon * CSpoon::Create(DEVICES)
{
	CSpoon*		pInstance = new CSpoon(pDevice, pDeviceContext);
...
CObj * CSpoon::Clone(void * pArg)
{
	CSpoon*		pInstance = new CSpoon(*this);
