#include "stdafx.h"
#include "..\Headers\Book0.h"

#include "Management.h"

CBook0::CBook0(DEVICES)
	:CObjList(pDevice, pDeviceContext)
{
}

CBook0::CBook0(const CBook0 & other)
	: CObjList(other)
{
}

HRESULT CBook0::Initialize_Prototype()
{
...
HRESULT CBook0::Initialize_Clone(void * pArg)
{
...
_int CBook0::Update(_double DeltaTime)
{
...
_int CBook0::Late_Update(_double DeltaTime)
{
...
HRESULT CBook0::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	ModelDesc.iModelIndexNum = 5;
	if (FAILED(__super::SetUp_Components(STAGEONE_SCENE, L"Component_Model_Book0", L"Com_Model", (CComponent**)&m_pModel, &ModelDesc)))
		return E_FAIL;
...
HRESULT CBook0::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CBook0 * CBook0::Create(DEVICES)
{
	CBook0*		pInstance = new CBook0(pDevice, pDeviceContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Creating CBook0");
...
CObj * CBook0::Clone(void * pArg)
{
	CBook0*		pInstance = new CBook0(*this);
