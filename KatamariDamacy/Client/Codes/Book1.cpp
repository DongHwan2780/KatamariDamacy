...
HRESULT CBook1::SetUp_Components()
{
	...
	ModelDesc.iModelIndexNum = 6;
	if (FAILED(__super::SetUp_Components(STAGEONE_SCENE, L"Component_Model_Book1", L"Com_Model", (CComponent**)&m_pModel, &ModelDesc)))
		return E_FAIL;
...
CBook1 * CBook1::Create(DEVICES)
{
	...
	{
		MSG_BOX("Failed to Creating CBook1");
