...
HRESULT CBat::Initialize_Clone(void * pArg)
{
...
_int CBat::Update(_double DeltaTime)
{
...
_int CBat::Late_Update(_double DeltaTime)
{
...
HRESULT CBat::SetUp_Components()
{
	...
	ModelDesc.iModelIndexNum = 3;
	if (FAILED(__super::SetUp_Components(STAGEONE_SCENE, L"Component_Model_Bat", L"Com_Model", (CComponent**)&m_pModel, &ModelDesc)))
		return E_FAIL;
