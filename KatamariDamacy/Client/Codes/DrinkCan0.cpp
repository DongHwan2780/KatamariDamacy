...
HRESULT CDrinkCan0::SetUp_Components()
{
	...
	ModelDesc.iModelIndexNum = 13;
	if (FAILED(__super::SetUp_Components(STAGEONE_SCENE, L"Component_Model_DrinkCan0", L"Com_Model", (CComponent**)&m_pModel, &ModelDesc)))
		return E_FAIL;
...
CDrinkCan0 * CDrinkCan0::Create(DEVICES)
{
	...
	{
		MSG_BOX("Failed to Creating CDrinkCan0");
