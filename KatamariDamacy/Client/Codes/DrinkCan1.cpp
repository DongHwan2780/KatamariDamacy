...
HRESULT CDrinkCan1::SetUp_Components()
{
	...
	ModelDesc.iModelIndexNum = 14;
	if (FAILED(__super::SetUp_Components(STAGEONE_SCENE, L"Component_Model_DrinkCan1", L"Com_Model", (CComponent**)&m_pModel, &ModelDesc)))
		return E_FAIL;
...
CDrinkCan1 * CDrinkCan1::Create(DEVICES)
{
	...
	{
		MSG_BOX("Failed to Creating CDrinkCan1");
