...
CToolCake::CToolCake(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolCake::CToolCake(const CToolCake & other)
	: CObj(other)
{
}

HRESULT CToolCake::Initialize_Prototype()
{
...
HRESULT CToolCake::Initialize_Clone(void * pArg)
{
...
_int CToolCake::Update(_double DeltaTime)
{
...
_int CToolCake::Late_Update(_double DeltaTime)
{
...
HRESULT CToolCake::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Cake", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolCake::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolCake * CToolCake::Create(DEVICES)
{
	CToolCake*		pInstance = new CToolCake(pDevice, pDeviceContext);
...
CObj * CToolCake::Clone(void * pArg)
{
	CToolCake*		pInstance = new CToolCake(*this);
