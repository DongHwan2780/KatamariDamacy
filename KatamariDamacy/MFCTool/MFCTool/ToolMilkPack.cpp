...
CToolMilkPack::CToolMilkPack(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolMilkPack::CToolMilkPack(const CToolMilkPack & other)
	: CObj(other)
{
}

HRESULT CToolMilkPack::Initialize_Prototype()
{
...
HRESULT CToolMilkPack::Initialize_Clone(void * pArg)
{
...
_int CToolMilkPack::Update(_double DeltaTime)
{
...
_int CToolMilkPack::Late_Update(_double DeltaTime)
{
...
HRESULT CToolMilkPack::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_MilkPack", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolMilkPack::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolMilkPack * CToolMilkPack::Create(DEVICES)
{
	CToolMilkPack*		pInstance = new CToolMilkPack(pDevice, pDeviceContext);
...
CObj * CToolMilkPack::Clone(void * pArg)
{
	CToolMilkPack*		pInstance = new CToolMilkPack(*this);
