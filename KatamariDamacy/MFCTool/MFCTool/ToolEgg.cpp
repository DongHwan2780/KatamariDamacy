...
CToolEgg::CToolEgg(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolEgg::CToolEgg(const CToolEgg & other)
	: CObj(other)
{
}

HRESULT CToolEgg::Initialize_Prototype()
{
...
HRESULT CToolEgg::Initialize_Clone(void * pArg)
{
...
_int CToolEgg::Update(_double DeltaTime)
{
...
_int CToolEgg::Late_Update(_double DeltaTime)
{
...
HRESULT CToolEgg::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Egg", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolEgg::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolEgg * CToolEgg::Create(DEVICES)
{
	CToolEgg*		pInstance = new CToolEgg(pDevice, pDeviceContext);
...
CObj * CToolEgg::Clone(void * pArg)
{
	CToolEgg*		pInstance = new CToolEgg(*this);
