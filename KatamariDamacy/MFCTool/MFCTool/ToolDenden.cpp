...
CToolDenden::CToolDenden(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolDenden::CToolDenden(const CToolDenden & other)
	: CObj(other)
{
}

HRESULT CToolDenden::Initialize_Prototype()
{
...
HRESULT CToolDenden::Initialize_Clone(void * pArg)
{
...
_int CToolDenden::Update(_double DeltaTime)
{
...
_int CToolDenden::Late_Update(_double DeltaTime)
{
...
HRESULT CToolDenden::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Denden", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolDenden::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolDenden * CToolDenden::Create(DEVICES)
{
	CToolDenden*		pInstance = new CToolDenden(pDevice, pDeviceContext);
...
CObj * CToolDenden::Clone(void * pArg)
{
	CToolDenden*		pInstance = new CToolDenden(*this);
