...
CToolMelon::CToolMelon(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolMelon::CToolMelon(const CToolMelon & other)
	: CObj(other)
{
}

HRESULT CToolMelon::Initialize_Prototype()
{
...
HRESULT CToolMelon::Initialize_Clone(void * pArg)
{
...
_int CToolMelon::Update(_double DeltaTime)
{
...
_int CToolMelon::Late_Update(_double DeltaTime)
{
...
HRESULT CToolMelon::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Melon", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolMelon::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolMelon * CToolMelon::Create(DEVICES)
{
	CToolMelon*		pInstance = new CToolMelon(pDevice, pDeviceContext);
...
CObj * CToolMelon::Clone(void * pArg)
{
	CToolMelon*		pInstance = new CToolMelon(*this);
