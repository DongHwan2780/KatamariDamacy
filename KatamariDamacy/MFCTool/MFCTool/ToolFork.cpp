...
CToolFork::CToolFork(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolFork::CToolFork(const CToolFork & other)
	: CObj(other)
{
}

HRESULT CToolFork::Initialize_Prototype()
{
...
HRESULT CToolFork::Initialize_Clone(void * pArg)
{
...
_int CToolFork::Update(_double DeltaTime)
{
...
_int CToolFork::Late_Update(_double DeltaTime)
{
...
HRESULT CToolFork::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Fork", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolFork::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolFork * CToolFork::Create(DEVICES)
{
	CToolFork*		pInstance = new CToolFork(pDevice, pDeviceContext);
...
CObj * CToolFork::Clone(void * pArg)
{
	CToolFork*		pInstance = new CToolFork(*this);
