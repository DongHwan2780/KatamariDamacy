...
CToolCandy::CToolCandy(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolCandy::CToolCandy(const CToolCandy & other)
	: CObj(other)
{
}

HRESULT CToolCandy::Initialize_Prototype()
{
...
HRESULT CToolCandy::Initialize_Clone(void * pArg)
{
...
_int CToolCandy::Update(_double DeltaTime)
{
...
_int CToolCandy::Late_Update(_double DeltaTime)
{
...
HRESULT CToolCandy::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Candy", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolCandy::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolCandy * CToolCandy::Create(DEVICES)
{
	CToolCandy*		pInstance = new CToolCandy(pDevice, pDeviceContext);
...
CObj * CToolCandy::Clone(void * pArg)
{
	CToolCandy*		pInstance = new CToolCandy(*this);
