...
CToolEraser::CToolEraser(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolEraser::CToolEraser(const CToolEraser & other)
	: CObj(other)
{
}

HRESULT CToolEraser::Initialize_Prototype()
{
...
HRESULT CToolEraser::Initialize_Clone(void * pArg)
{
...
_int CToolEraser::Update(_double DeltaTime)
{
...
_int CToolEraser::Late_Update(_double DeltaTime)
{
...
HRESULT CToolEraser::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CToolEraser::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolEraser * CToolEraser::Create(DEVICES)
{
	CToolEraser*		pInstance = new CToolEraser(pDevice, pDeviceContext);
...
CObj * CToolEraser::Clone(void * pArg)
{
	CToolEraser*		pInstance = new CToolEraser(*this);
