...
CToolTulip::CToolTulip(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolTulip::CToolTulip(const CToolTulip & other)
	: CObj(other)
{
}

HRESULT CToolTulip::Initialize_Prototype()
{
...
HRESULT CToolTulip::Initialize_Clone(void * pArg)
{
...
_int CToolTulip::Update(_double DeltaTime)
{
...
_int CToolTulip::Late_Update(_double DeltaTime)
{
...
HRESULT CToolTulip::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CToolTulip::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolTulip * CToolTulip::Create(DEVICES)
{
	CToolTulip*		pInstance = new CToolTulip(pDevice, pDeviceContext);
...
CObj * CToolTulip::Clone(void * pArg)
{
	CToolTulip*		pInstance = new CToolTulip(*this);
