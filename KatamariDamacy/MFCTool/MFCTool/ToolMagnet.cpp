...
CToolMagnet::CToolMagnet(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolMagnet::CToolMagnet(const CToolMagnet & other)
	: CObj(other)
{
}

HRESULT CToolMagnet::Initialize_Prototype()
{
...
HRESULT CToolMagnet::Initialize_Clone(void * pArg)
{
...
_int CToolMagnet::Update(_double DeltaTime)
{
...
_int CToolMagnet::Late_Update(_double DeltaTime)
{
...
HRESULT CToolMagnet::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Magnet", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolMagnet::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolMagnet * CToolMagnet::Create(DEVICES)
{
	CToolMagnet*		pInstance = new CToolMagnet(pDevice, pDeviceContext);
...
CObj * CToolMagnet::Clone(void * pArg)
{
	CToolMagnet*		pInstance = new CToolMagnet(*this);
