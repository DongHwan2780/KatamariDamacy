...
CToolStand::CToolStand(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolStand::CToolStand(const CToolStand & other)
	: CObj(other)
{
}

HRESULT CToolStand::Initialize_Prototype()
{
...
HRESULT CToolStand::Initialize_Clone(void * pArg)
{
...
_int CToolStand::Update(_double DeltaTime)
{
...
_int CToolStand::Late_Update(_double DeltaTime)
{
...
HRESULT CToolStand::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Stand", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolStand::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolStand * CToolStand::Create(DEVICES)
{
	CToolStand*		pInstance = new CToolStand(pDevice, pDeviceContext);
...
CObj * CToolStand::Clone(void * pArg)
{
	CToolStand*		pInstance = new CToolStand(*this);
