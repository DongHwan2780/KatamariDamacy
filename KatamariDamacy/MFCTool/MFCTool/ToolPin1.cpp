...
CToolPin1::CToolPin1(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolPin1::CToolPin1(const CToolPin1 & other)
	: CObj(other)
{
}

HRESULT CToolPin1::Initialize_Prototype()
{
...
HRESULT CToolPin1::Initialize_Clone(void * pArg)
{
...
_int CToolPin1::Update(_double DeltaTime)
{
...
_int CToolPin1::Late_Update(_double DeltaTime)
{
...
HRESULT CToolPin1::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Pin1", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolPin1::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolPin1 * CToolPin1::Create(DEVICES)
{
	CToolPin1*		pInstance = new CToolPin1(pDevice, pDeviceContext);
...
CObj * CToolPin1::Clone(void * pArg)
{
	CToolPin1*		pInstance = new CToolPin1(*this);
