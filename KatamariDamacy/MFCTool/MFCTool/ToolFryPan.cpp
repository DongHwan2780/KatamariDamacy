...
CToolFryPan::CToolFryPan(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolFryPan::CToolFryPan(const CToolFryPan & other)
	: CObj(other)
{
}

HRESULT CToolFryPan::Initialize_Prototype()
{
...
HRESULT CToolFryPan::Initialize_Clone(void * pArg)
{
...
_int CToolFryPan::Update(_double DeltaTime)
{
...
_int CToolFryPan::Late_Update(_double DeltaTime)
{
...
HRESULT CToolFryPan::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_FryPan", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolFryPan::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolFryPan * CToolFryPan::Create(DEVICES)
{
	CToolFryPan*		pInstance = new CToolFryPan(pDevice, pDeviceContext);
...
CObj * CToolFryPan::Clone(void * pArg)
{
	CToolFryPan*		pInstance = new CToolFryPan(*this);
