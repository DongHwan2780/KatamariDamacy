...
CToolBook0::CToolBook0(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolBook0::CToolBook0(const CToolBook0 & other)
	: CObj(other)
{
}

HRESULT CToolBook0::Initialize_Prototype()
{
...
HRESULT CToolBook0::Initialize_Clone(void * pArg)
{
...
_int CToolBook0::Update(_double DeltaTime)
{
...
_int CToolBook0::Late_Update(_double DeltaTime)
{
...
HRESULT CToolBook0::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Book0", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolBook0::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolBook0 * CToolBook0::Create(DEVICES)
{
	CToolBook0*		pInstance = new CToolBook0(pDevice, pDeviceContext);
...
CObj * CToolBook0::Clone(void * pArg)
{
	CToolBook0*		pInstance = new CToolBook0(*this);
