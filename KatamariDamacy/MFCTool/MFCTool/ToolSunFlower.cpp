...
CToolSunFlower::CToolSunFlower(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolSunFlower::CToolSunFlower(const CToolSunFlower & other)
	: CObj(other)
{
}

HRESULT CToolSunFlower::Initialize_Prototype()
{
...
HRESULT CToolSunFlower::Initialize_Clone(void * pArg)
{
...
_int CToolSunFlower::Update(_double DeltaTime)
{
...
_int CToolSunFlower::Late_Update(_double DeltaTime)
{
...
HRESULT CToolSunFlower::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_SunFlower", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolSunFlower::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolSunFlower * CToolSunFlower::Create(DEVICES)
{
	CToolSunFlower*		pInstance = new CToolSunFlower(pDevice, pDeviceContext);
...
CObj * CToolSunFlower::Clone(void * pArg)
{
	CToolSunFlower*		pInstance = new CToolSunFlower(*this);
