...
CToolBanana::CToolBanana(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolBanana::CToolBanana(const CToolBanana & other)
	: CObj(other)
{
}

HRESULT CToolBanana::Initialize_Prototype()
{
...
HRESULT CToolBanana::Initialize_Clone(void * pArg)
{
...
_int CToolBanana::Update(_double DeltaTime)
{
...
_int CToolBanana::Late_Update(_double DeltaTime)
{
...
HRESULT CToolBanana::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CToolBanana::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolBanana * CToolBanana::Create(DEVICES)
{
	CToolBanana*		pInstance = new CToolBanana(pDevice, pDeviceContext);
...
CObj * CToolBanana::Clone(void * pArg)
{
	CToolBanana*		pInstance = new CToolBanana(*this);
