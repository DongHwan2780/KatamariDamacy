...
CToolBook1::CToolBook1(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolBook1::CToolBook1(const CToolBook1 & other)
	: CObj(other)
{
}

HRESULT CToolBook1::Initialize_Prototype()
{
...
HRESULT CToolBook1::Initialize_Clone(void * pArg)
{
...
_int CToolBook1::Update(_double DeltaTime)
{
...
_int CToolBook1::Late_Update(_double DeltaTime)
{
...
HRESULT CToolBook1::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Book1", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolBook1::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolBook1 * CToolBook1::Create(DEVICES)
{
	CToolBook1*		pInstance = new CToolBook1(pDevice, pDeviceContext);
...
CObj * CToolBook1::Clone(void * pArg)
{
	CToolBook1*		pInstance = new CToolBook1(*this);
