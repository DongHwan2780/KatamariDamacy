...
CToolDrinkCan0::CToolDrinkCan0(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolDrinkCan0::CToolDrinkCan0(const CToolDrinkCan0 & other)
	: CObj(other)
{
}

HRESULT CToolDrinkCan0::Initialize_Prototype()
{
...
HRESULT CToolDrinkCan0::Initialize_Clone(void * pArg)
{
...
_int CToolDrinkCan0::Update(_double DeltaTime)
{
...
_int CToolDrinkCan0::Late_Update(_double DeltaTime)
{
...
HRESULT CToolDrinkCan0::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CToolDrinkCan0::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolDrinkCan0 * CToolDrinkCan0::Create(DEVICES)
{
	CToolDrinkCan0*		pInstance = new CToolDrinkCan0(pDevice, pDeviceContext);
...
CObj * CToolDrinkCan0::Clone(void * pArg)
{
	CToolDrinkCan0*		pInstance = new CToolDrinkCan0(*this);
