...
CToolLipStick::CToolLipStick(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolLipStick::CToolLipStick(const CToolLipStick & other)
	: CObj(other)
{
}

HRESULT CToolLipStick::Initialize_Prototype()
{
...
HRESULT CToolLipStick::Initialize_Clone(void * pArg)
{
...
_int CToolLipStick::Update(_double DeltaTime)
{
...
_int CToolLipStick::Late_Update(_double DeltaTime)
{
...
HRESULT CToolLipStick::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_LipStick", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolLipStick::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolLipStick * CToolLipStick::Create(DEVICES)
{
	CToolLipStick*		pInstance = new CToolLipStick(pDevice, pDeviceContext);
...
CObj * CToolLipStick::Clone(void * pArg)
{
	CToolLipStick*		pInstance = new CToolLipStick(*this);
