...
CToolTree::CToolTree(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolTree::CToolTree(const CToolTree & other)
	: CObj(other)
{
}

HRESULT CToolTree::Initialize_Prototype()
{
...
HRESULT CToolTree::Initialize_Clone(void * pArg)
{
...
_int CToolTree::Update(_double DeltaTime)
{
...
_int CToolTree::Late_Update(_double DeltaTime)
{
...
HRESULT CToolTree::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Tree", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolTree::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolTree * CToolTree::Create(DEVICES)
{
	CToolTree*		pInstance = new CToolTree(pDevice, pDeviceContext);
...
CObj * CToolTree::Clone(void * pArg)
{
	CToolTree*		pInstance = new CToolTree(*this);
