...
CToolDice::CToolDice(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolDice::CToolDice(const CToolDice & other)
	: CObj(other)
{
}

HRESULT CToolDice::Initialize_Prototype()
{
...
HRESULT CToolDice::Initialize_Clone(void * pArg)
{
...
_int CToolDice::Update(_double DeltaTime)
{
...
_int CToolDice::Late_Update(_double DeltaTime)
{
...
HRESULT CToolDice::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Dice", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolDice::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolDice * CToolDice::Create(DEVICES)
{
	CToolDice*		pInstance = new CToolDice(pDevice, pDeviceContext);
...
CObj * CToolDice::Clone(void * pArg)
{
	CToolDice*		pInstance = new CToolDice(*this);
