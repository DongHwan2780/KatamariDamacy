...
CToolBansai::CToolBansai(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolBansai::CToolBansai(const CToolBansai & other)
	: CObj(other)
{
}

HRESULT CToolBansai::Initialize_Prototype()
{
...
HRESULT CToolBansai::Initialize_Clone(void * pArg)
{
...
_int CToolBansai::Update(_double DeltaTime)
{
...
_int CToolBansai::Late_Update(_double DeltaTime)
{
...
HRESULT CToolBansai::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Bansai", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolBansai::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolBansai * CToolBansai::Create(DEVICES)
{
	CToolBansai*		pInstance = new CToolBansai(pDevice, pDeviceContext);
...
CObj * CToolBansai::Clone(void * pArg)
{
	CToolBansai*		pInstance = new CToolBansai(*this);
