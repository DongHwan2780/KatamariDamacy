...
CToolPilon::CToolPilon(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolPilon::CToolPilon(const CToolPilon & other)
	: CObj(other)
{
}

HRESULT CToolPilon::Initialize_Prototype()
{
...
HRESULT CToolPilon::Initialize_Clone(void * pArg)
{
...
_int CToolPilon::Update(_double DeltaTime)
{
...
_int CToolPilon::Late_Update(_double DeltaTime)
{
...
HRESULT CToolPilon::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Pilon", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolPilon::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolPilon * CToolPilon::Create(DEVICES)
{
	CToolPilon*		pInstance = new CToolPilon(pDevice, pDeviceContext);
...
CObj * CToolPilon::Clone(void * pArg)
{
	CToolPilon*		pInstance = new CToolPilon(*this);
