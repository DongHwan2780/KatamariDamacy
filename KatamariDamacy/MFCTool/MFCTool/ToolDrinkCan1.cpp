...
CToolDrinkCan1::CToolDrinkCan1(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolDrinkCan1::CToolDrinkCan1(const CToolDrinkCan1 & other)
	: CObj(other)
{
}

HRESULT CToolDrinkCan1::Initialize_Prototype()
{
...
HRESULT CToolDrinkCan1::Initialize_Clone(void * pArg)
{
...
_int CToolDrinkCan1::Update(_double DeltaTime)
{
...
_int CToolDrinkCan1::Late_Update(_double DeltaTime)
{
...
HRESULT CToolDrinkCan1::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CToolDrinkCan1::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolDrinkCan1 * CToolDrinkCan1::Create(DEVICES)
{
	CToolDrinkCan1*		pInstance = new CToolDrinkCan1(pDevice, pDeviceContext);
...
CObj * CToolDrinkCan1::Clone(void * pArg)
{
	CToolDrinkCan1*		pInstance = new CToolDrinkCan1(*this);
