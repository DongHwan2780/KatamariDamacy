...
CToolSpoon::CToolSpoon(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolSpoon::CToolSpoon(const CToolSpoon & other)
	: CObj(other)
{
}

HRESULT CToolSpoon::Initialize_Prototype()
{
...
HRESULT CToolSpoon::Initialize_Clone(void * pArg)
{
...
_int CToolSpoon::Update(_double DeltaTime)
{
...
_int CToolSpoon::Late_Update(_double DeltaTime)
{
...
HRESULT CToolSpoon::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Spoon", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolSpoon::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolSpoon * CToolSpoon::Create(DEVICES)
{
	CToolSpoon*		pInstance = new CToolSpoon(pDevice, pDeviceContext);
...
CObj * CToolSpoon::Clone(void * pArg)
{
	CToolSpoon*		pInstance = new CToolSpoon(*this);
