...
CToolOrange::CToolOrange(DEVICES)
	:CObj(pDevice, pDeviceContext)
{
}

CToolOrange::CToolOrange(const CToolOrange & other)
	: CObj(other)
{
}

HRESULT CToolOrange::Initialize_Prototype()
{
...
HRESULT CToolOrange::Initialize_Clone(void * pArg)
{
...
_int CToolOrange::Update(_double DeltaTime)
{
...
_int CToolOrange::Late_Update(_double DeltaTime)
{
...
HRESULT CToolOrange::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(STATIC_SCENE, L"Component_Model_Orange", L"Com_Model", (CComponent**)&m_pModel)))
		return E_FAIL;
...
HRESULT CToolOrange::SetUp_ConstantTable()
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CToolOrange * CToolOrange::Create(DEVICES)
{
	CToolOrange*		pInstance = new CToolOrange(pDevice, pDeviceContext);
...
CObj * CToolOrange::Clone(void * pArg)
{
	CToolOrange*		pInstance = new CToolOrange(*this);
